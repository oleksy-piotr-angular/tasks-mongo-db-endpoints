...
<div>
  <ul>
    ...
    <ul>
      ...
      <ul>
        ...
        <ul>
          <li>
            should call "taskService.clearDoneTasksInDB()" to clear the list of
            completed tasks
          </li>
        </ul>
      </ul>
      <ul>
        ...
        <ul>
          <li>
            should render "button" with defined text and click event for method
            "clear()"
          </li>
        </ul>
        <ul>
    ...
    <ul>
      ...
      <ul>
        ...
        <ul>
          <li>
            should call "taskService.clearDoneTasksInDB()" to clear the list of
            completed tasks from "tasksList$"
          </li>
        </ul>
      </ul>
      <ul>
  ...
  <ul>
    ...
    <ul>
      ...
      <ul>
        ...
        <ul>
          <li>
            should call "TaskService.add()" which will add a new task with "_id"
            received after calling "HttpService.saveOneTask()" sending requests
            to API
          </li>
        </ul>
      </ul>
  ...
  <ul>
    ...
    <ul>
      ...
      <ul>
        ...
        <ul>
          <li>
            should initialize the "Task[]" array as the value of the "tasksDone"
            property from the returned and filtered array from
    ...
    <ul>
      ...
      <ul>
        ...
        <ul>
          <li>
            should render div "#tasksDoneTemplate" if Tasks Behavior Subject has
            Elements
          </li>
        </ul>
        <ul>
          <li>
            should render Paragraph Element with info about number of Completed
            Tasks
          </li>
        </ul>
        <ul>
          <li>
            should render &lt;ol&gt; with the same number of &lt;li&gt; elements
            as the number of completed tasks
          </li>
        </ul>
        <ul>
          <li>
            should in &lt;li&gt;render &lt;div&gt; with name property content of
            tasks if "task" has "end" property which is used in [appDate] pipe
          </li>
        </ul>
      </ul>
    </ul>
    ...
    <ul>
      ...
      <ul>
        ...
        <ul>
          ...
          <ul>
            <li>
              should call "taskService.remove()" method with "task" to remove in
              params
            </li>
          </ul>
        </ul>
      ...
      <ul>
        ...
        <ul>
          ...
          <ul>
            ...
            <ul>
              <li>
                should in &lt;li&gt; render &lt;p&gt; with name property content
                of tasks if "task" has "created" property which is used in
                [appDate] pipe
              </li>
            </ul>
            <ul>
            ...
            <ul>
              <li>
                should render "Done" button with defined class and "click" event
                which handle "done()" method for each
              </li>
            </ul>
          </ul>
        </ul>
    ...
    <ul>
      ...
      <ul>
        ...
        <ul>
          <li>remove()</li>
          <ul>
            <li>should remove given task from "tasksList[]" param elements</li>
          </ul>
        </ul>
        <ul>
          <li>done()</li>
  ...
  <ul>
    ...
    <ul>
      ...
      <ul>
        <li>
          should send expected body with the task to API to save it and receive
          "_id" value for it
        </li>
      </ul>
    </ul>
    <ul>
      ...
      <ul>
        <li>should send expected body to remove all Completed Tasks in API</li>
      </ul>
    </ul>
    <ul>
  ...
  <ul>
    ...
    <ul>
      ...
      <ul>
        <li>getTaskList$()</li>
        <ul>
          <li>should return an array from the private property "taskList$"</li>
        </ul>
      </ul>
      <ul>
        <li>add()</li>
      ...
      <ul>
        ...
        <ul>
          <li>
            should call "httpService.removeOneTask()" method only one time with
            given Param
          </li>
        </ul>
        <ul>
      ...
      <ul>
        ...
        <ul>
          <li>
            should call "httpService.updateOneTaskToDone()" method only one time
            with given Param
          </li>
        </ul>
        <ul>
    ...
    <ul>
      ...
      <ul>
        ...
        <ul>
          <li>
            should call private method "getTasksFromDB()" when is initialized to
            send "POST" method
          </li>
        </ul>
      </ul>
      ...
      <ul>
        <li>add()</li>
        <ul>
          <li>should call "httpService.saveOneTask() to send "POST" method"</li>
        </ul>
        <ul>
          <li>
  ...
  <ul>
    ...
    <ul>
      ...
      <ul>
        <li>mouseLeave()</li>
        <ul>
          <li>should remove a "Paragraph" child when mouse leave an element</li>
        </ul>
      </ul>
    </ul>
    <ul>
