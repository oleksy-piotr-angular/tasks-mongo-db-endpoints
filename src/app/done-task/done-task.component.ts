    ...
    this.tasksService
      ...
      .subscribe((tasks: Array<Task>) => {
        this.tasksDone = tasks
          ...
          .slice(); //1. after subsribing actual state of 'tasksDone' Array<string> from TasksService we assign it to internal variable 'taksDone' instead Using @Input() (property-binding) as below(we don't neeed to pass data from Parent because Everything is in 'TasksService'):
